...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        formals_body = Pair(signature.rest, expressions.rest) # expression with bid and formal to pass
        env.define(signature.first, do_lambda_form(formals_body, env))
...
def do_let_form(expressions, env):
    ...
    validate_form(expressions, 2)
    # return expressions.first.first.first
